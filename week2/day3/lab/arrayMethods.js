...
// CODE HERE
const evenNumbers = mixedNumbers.filter(even => even % 2 === 0) // = mixedNumbers.filter(/* Provide Your Callback Here */)
...
const reduced = populations.reduce((a, c) => a + c)
// console.log(reduced)
...
const myStrongest = monstersInYourPocket.filter(function(strong) {
...
// // CODE HERE
const orderTotals = orders.map(function(orders){
  return (orders.tax +1) * orders.price
})
...
// // CODE HERE
const bobsTotal = purchases.filter(function(purchase){
