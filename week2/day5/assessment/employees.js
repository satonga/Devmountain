...
//CODE HERE
class Employee {
    constructor(names, shift) {
        this.names = names;
        this.shift = shift
    }
    getSchedule() {
        console.log(`${this.names} works on ${this.shift}.`)
    }
}
...
//CODE HERE
let empOne = new Employee(`Shantel`, `Monday, Wednesday, Friday; 7-5`)
/*
...
class Manager extends Employee {
    constructor(names, shifts, employees){
        ...
        empArr.push(this.employees)
    }
    getEmployees(){
        
        console.log(`${this.names} manages ${empArr}`)
    }
    addemployee(emp){
        empArr.push(emp)
    }
